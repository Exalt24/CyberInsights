      ...
      <div className="max-w-3xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-4">
            <li>
              <a href="#" className="text-gray-600 dark:text-gray-300 hover:text-blue-600 transition-colors duration-200">
                Home
              </a>
            </li>
            <li>
...
function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 py-4">
      <div className="max-w-3xl mx-auto px-4 text-center text-gray-600 dark:text-gray-300">
        <p>&copy; {new Date().getFullYear()} CyberSecurity Insights. All rights reserved.</p>
...
export default function Home() {
  return (
    <>
      ...
      <main id="top" className="bg-gray-100 dark:bg-gray-900 min-h-screen py-10 px-4">
        <article className="max-w-3xl mx-auto bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 p-8 rounded-lg shadow-lg">
          ...
          <nav className="mb-8 border-b pb-4">
            ...
            <ul className="list-decimal ml-6 space-y-2">
              <li>
                <a href="#introduction" className="hover:text-blue-600 transition-colors duration-200">
                  Introduction
                </a>
              </li>
              <li>
                <a href="#what-is-computer-security" className="hover:text-blue-600 transition-colors duration-200">
                  What is Computer Security?
                </a>
              </li>
              <li>
                <a href="#security-principles" className="hover:text-blue-600 transition-colors duration-200">
                  Overview of Security Principles
                </a>
              </li>
              <li>
                <a href="#human-factors" className="hover:text-blue-600 transition-colors duration-200">
                  Human Factors
                </a>
              </li>
              <li>
                <a href="#real-world-breaches" className="hover:text-blue-600 transition-colors duration-200">
                  Real-World Breaches
                </a>
              </li>
              <li>
                <a href="#common-mistakes" className="hover:text-blue-600 transition-colors duration-200">
                  Common Security Mistakes
                </a>
              </li>
              <li>
                <a href="#best-practices" className="hover:text-blue-600 transition-colors duration-200">
                  Best Practices
                </a>
              </li>
              <li>
                <a href="#conclusion" className="hover:text-blue-600 transition-colors duration-200">
                  Conclusion
                </a>
              </li>
            </ul>
          ...
          {/* WHAT IS COMPUTER SECURITY */}
          <section id="what-is-computer-security" className="mb-10">
          ...
          {/* OVERVIEW OF SECURITY PRINCIPLES */}
          <section id="security-principles" className="mb-10">
          ...
          {/* HUMAN FACTORS */}
          <section id="human-factors" className="mb-10">
          ...
          {/* REAL-WORLD BREACHES */}
          <section id="real-world-breaches" className="mb-10">
